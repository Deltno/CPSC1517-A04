...
namespace OOPsReview
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //new cause an instance (occurance) of the specified class to be created and placed in the receiving variable
            //the variable is a pointer address to the actual physical memory location of the instance

            //declaring an instance (occurance) of the specified class will not create a physical instance, just a pointer which can hold a physical instance
            Turn theTurn;
            List<Turn> rounds = new List<Turn>();
            //new cause the constructor of a class to execute and a physical instance to be created
                        ...
                        case "B":
                            {
                                ...
                                // two: the output conversion value if the string can be converted
