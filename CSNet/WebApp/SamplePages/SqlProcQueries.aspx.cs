...
namespace WebApp.SamplePages
{
    public partial class SqlProcQueries : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //the dropdown list (ddl) control will be loaded with data from the database
            ...
            if (!Page.IsPostBack)
            {
                ...
                try
                {
                    ...
                    CategoryController symgr = new CategoryController();
                    //issue the request to the appropriate BLL class method and capture results
                    List<Category> datainfo = symgr.Category_List();
                    ...
                    //phyiscally bind the data to the ddl control
